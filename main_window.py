...
from ButtonsSetName import set_name_event, set_name_dristpunk
...
class Window(QFrame):
    def __init__(self):
        ...
        ###########################################
        #### Connect buttons
        self.ui.Dristpunk_Button.setText(set_name_dristpunk())
        self.ui.Event_Button.setText(set_name_event())
